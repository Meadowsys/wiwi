...
// generated by script `generate-z85-table-decoder`
...
/// One frame of this many bytes (4) from the binary data maps to one frame of
/// [`STRING_FRAME_LEN`] bytes in encoded Z85 output.
pub const BINARY_FRAME_LEN: usize = 4;
/// One frame of this many bytes (5) from the encoded Z85 data maps to one frame
/// of [`BINARY_FRAME_LEN`] bytes (4) in binary data.
