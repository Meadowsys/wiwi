...
// TODO: this can be size-optimised. Instead of Option, have u8::MAX
// represent None. Should not have performance impact I think
pub static TABLE_DECODER: [Option<u8>; 256] = [
